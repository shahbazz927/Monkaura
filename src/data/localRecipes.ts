...
export function convertLocalRecipe(recipe: LocalRecipe): AIRecipe {
  return {
    ...
    description: `A delicious ${recipe.category.toLowerCase()} featuring ${recipe.mainIngredient} with a ${recipe.sweeteningStyle.toLowerCase()} sweetening style — sweetened with Monkaura Erythritol & Monk Fruit Sweetener (1:1 sugar replacement).`,
    ...
    nutrition: {
      ...
      monkauraSavings: "0g added sugar, 0g net carbs per serving with 1:1 sugar replacement from Monkaura Erythritol & Monk Fruit.",
    },
