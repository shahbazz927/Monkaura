      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        {!hasReviews ? (
          <div className="bg-brand-cream/60 border border-gray-100 rounded-3xl p-8 sm:p-10 space-y-4">
            ...
            <p className="text-sm text-brand-dark/60 font-light max-w-lg mx-auto">Try our 100g Trial or 200g Everyday pack (Erythritol + Monk Fruit — available now) and share your experience.</p>
