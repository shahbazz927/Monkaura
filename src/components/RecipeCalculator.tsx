...
const LOADING_MESSAGES = [
  ...
  "Replacing traditional sugar with Monkaura Allulose & Monk Fruit...",
  "Calibrating measurements for flawless browning and caramelization...",
  "Ensuring 100% diabetic-safe and keto-friendly macro ratios...",
...
Made healthy with Monkaura — Zero-Sugar, Zero-Spike Allulose & Monk Fruit Blend!
    `;
    ...
    <section id="recipe-hub" className="py-16 md:py-24 bg-white relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-4">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-brand-green/10 text-brand-green font-bold text-xs uppercase tracking-wider">
            <ChefHat size={14} className="text-brand-green animate-pulse" />
            <span>Monkaura Culinary Hub</span>
          </div>
          <h1 className="font-serif font-extrabold text-3xl sm:text-4xl text-brand-dark tracking-tight">
            Sugar-Free Kitchen Innovations
          </h1>
          <p className="text-brand-dark/70 text-sm font-light leading-relaxed">
            Monkaura measures and sweetens 1:1 exactly like real sugar, making low-carb cooking simple. 
            Calculate your savings or generate customized culinary masterpieces instantly!
          </p>

          {/* Luxury Tab Switcher */}
          <div className="inline-flex p-1 bg-brand-cream border border-brand-green/10 rounded-2xl max-w-md w-full mt-6 shadow-md">
            <button
            ...
            >
              <Calculator size={16} />
              <span>Smart Sugar Calculator</span>
            </button>
            <button
            ...
            >
              <Sparkles size={16} className={activeTab === "generator" ? "animate-spin" : ""} />
