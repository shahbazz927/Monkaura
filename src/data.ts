...
export const PRODUCTS: Product[] = [
  {
    ...
    subtitle: "Try before you stock up",
    description: "New to Monkaura? Start with the 100g Trial Pack — Monk Fruit, Erythritol for everyday tea, coffee, cooking and baking. Same great sweetness, perfect for trying before you switch your kitchen.",
    price: 149,
    originalPrice: 189,
    weight: "100g",
    ...
    tagline: "100g Trial Pack — Monk Fruit, Erythritol, 1:1 sugar replacement • Available Now",
    benefits: [
      "Monk Fruit, Erythritol — Available Now",
      "Sugar-like taste",
    ...
    features: [
      { title: "Monk Fruit, Erythritol", description: "Made with premium Erythritol and Monk Fruit for a smooth, sugar-like sweetness. Our current everyday blend — available now." },
  ...
  },
  {
    ...
    subtitle: "For everyday cooking",
    description: "Made for regular use — 200g Monk Fruit, Erythritol delivers smooth, sugar-like sweetness for your daily tea, coffee, cooking and baking. The everyday pack for families who've made the switch.",
    price: 298,
    originalPrice: 378,
    weight: "200g",
    ...
    tagline: "200g Everyday Pack — Monk Fruit, Erythritol, 1:1 sugar replacement • Available Now",
    benefits: [
      "Monk Fruit, Erythritol — Available Now",
      "Sugar-like taste",
      "1:1 sugar replacement",
...
export const DESSERT_RECIPES: DessertRecipe[] = [
  {
    ...
    steps: [
      ...
      "Create a sugar-free syrup by dissolving Monkaura 1:1 with water, simmering with crushed cardamom and saffron.",
      "Soak fried jamuns in warm Monkaura syrup for 2 hours. Monkaura syrup absorbs deeply for authentic sweet texture without added calories!"
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Turn off heat and stir in Monkaura (1:1 substitution). It dissolves smoothly with no metallic or bitter aftertaste!"
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Add Monkaura 1:1. Cook for another 2-3 minutes until the ghee separates cleanly from the sides of the pan for an authentic festive dessert."
    ],
