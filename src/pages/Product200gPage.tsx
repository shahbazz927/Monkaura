...
import { Check, Plus, Minus, ShoppingBag, ShieldCheck, Truck, RefreshCw, Star, Info } from "lucide-react";
...
export default function Product200gPage({ onAddToCart }: ProductPageProps) {
  const product = PRODUCTS.find(p => p.id === "pouch") || PRODUCTS[1] || PRODUCTS[0];
  ...
  return (
    <div className="bg-brand-cream min-h-screen pb-16">
      <Helmet>
        <title>Buy Monk Fruit Sweetener 200g Online India — Monkaura Everyday Pack (₹298)</title>
        <meta
          name="description"
          content="Buy Monkaura 200g Everyday Pack online in India: Premium Monk Fruit, Erythritol natural sweetener blend. 1:1 sugar replacement for everyday tea, coffee, cooking and baking. ₹298."
        />
        <meta
          name="keywords"
          content="buy monk fruit sweetener online, monk fruit sweetener 200g, monkaura 200g everyday pack, natural sweetener 200g india, 1:1 sugar substitute india"
        />
        <link rel="canonical" href="https://monkaura.in/products/monkaura-200g" />
        <meta property="og:title" content="Buy Monk Fruit Sweetener 200g Online India — Monkaura Everyday (₹298)" />
        <meta
          property="og:description"
          content="200g Everyday Pack of Monkaura Erythritol & Monk Fruit blend. Zero added sugar, 1:1 sugar replacement. Available now across India."
        />
        <meta property="og:url" content="https://monkaura.in/products/monkaura-200g" />
        <meta property="og:type" content="product" />
        <meta property="og:image" content={images[0]} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Buy Monkaura 200g Monk Fruit Sweetener (₹298)" />
        <meta name="twitter:description" content="200g Everyday Pack — Monk Fruit, Erythritol. 1:1 sugar replacement." />

        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            "name": "Monkaura 200g Everyday Pack - Monk Fruit, Erythritol",
            "image": images,
            "description": "Monkaura 200g Everyday Pack: Table-top natural sweetener blend of non-GMO Erythritol and Monk Fruit extract (Siraitia grosvenorii). 1:1 sugar replacement ratio for tea, coffee, cooking and baking.",
            "sku": "MONKAURA-200G",
            "mpn": "MK-200G-ERY-MF",
            "brand": {
              "@type": "Brand",
            ...
            "offers": {
              "@type": "Offer",
              "url": "https://monkaura.in/products/monkaura-200g",
              "priceCurrency": "INR",
              "price": 298,
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Monkaura 200g Everyday Pack", "item": "https://monkaura.in/products/monkaura-200g" }
            ]
          })}
        </script>
      </Helmet>
      ...
      <SEOBreadcrumb
        items={[
          ...
          { name: "Monkaura 200g Everyday Pack", url: "/products/monkaura-200g" }
        ]}
      />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="aspect-square bg-white rounded-3xl p-4 border border-gray-100 shadow-sm overflow-hidden flex items-center justify-center">
              <img
                ...
                alt={`Monkaura 200g Everyday Pack monk fruit sweetener pouch view ${activeImgIdx + 1}`}
            ...
            {images.length > 1 && (
              <div className="flex gap-3 overflow-x-auto pb-2">
                {images.map((img, i) => (
                  ...
                  >
                    <img src={img} alt={`Monkaura 200g Everyday Pack thumbnail view ${i + 1}`} className="w-full h-full object-contain" referrerPolicy="no-referrer" />
                  </button>
                ))}
              </div>
            )}
            ...
            <div className="bg-brand-mint-light/60 border border-brand-green/15 rounded-2xl p-4 text-xs space-y-2 text-brand-dark/80">
              <div className="flex items-center gap-2 font-bold text-brand-green">
                <Info size={16} />
                <span>The Everyday Kitchen Standard</span>
              </div>
              <p>
                The ideal pack size for families and daily users. Replaces sugar 1:1 across up to 50 servings of beverages, cooking, and home baking.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs flex items-baseline gap-3">
              <span className="text-3xl font-black text-brand-dark">₹298</span>
              <span className="text-lg text-brand-dark/40 line-through">₹378</span>
            ...
            <p className="text-sm text-brand-dark/80 leading-relaxed font-light">
              Made for regular use — 200g Monk Fruit, Erythritol delivers smooth, sugar-like sweetness for your daily tea, coffee, cooking, and baking. The everyday pack for families who have made the switch to clean, natural sweetness.
            </p>
            ...
            <div className="space-y-3 pt-2">
              ...
              >
                <span>Buy Now via Instant Checkout (₹{298 * qty})</span>
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-xs space-y-4 text-xs sm:text-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-4 border-t border-gray-100 pt-3 text-xs">
                ...
                <div><span className="text-brand-dark/60">Net Quantity:</span> <strong className="font-semibold text-brand-dark">200g</strong></div>
        ...
        <div className="mt-16 bg-white p-6 sm:p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <span className="text-xs font-bold text-brand-green uppercase tracking-widest">New to Monkaura?</span>
            <h3 className="font-serif font-bold text-2xl text-brand-dark mt-1">Start with the 100g Trial Pack</h3>
            <p className="text-xs sm:text-sm text-brand-dark/70 mt-1">Try the clean sweetness before stocking up your kitchen at just ₹149.</p>
          </div>
          <Link
